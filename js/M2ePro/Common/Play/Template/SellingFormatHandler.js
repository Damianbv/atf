...
CommonPlayTemplateSellingFormatHandler.prototype = Object.extend(new CommonHandler(), {
    ...
    attribute_sets_confirm: function()
    {
        ...
        AttributeSetHandlerObj.renderAttributesWithEmptyOption('price_gbr_custom_attribute', 'price_gbr_custom_attribute_td');
        AttributeSetHandlerObj.renderAttributesWithEmptyOption('price_euro_custom_attribute', 'price_euro_custom_attribute_td');
    },
