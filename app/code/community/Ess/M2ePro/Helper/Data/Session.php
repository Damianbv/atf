...
class Ess_M2ePro_Helper_Data_Session extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getSingleton('adminhtml/session')->getData(Ess_M2ePro_Helper_Data::CUSTOM_IDENTIFIER.'_'.$key, $clear);
    }
    ...
    public function getAllValues()
    {
        ...
        foreach ($session as $key => $value) {
            if (substr($key, 0, strlen(Ess_M2ePro_Helper_Data::CUSTOM_IDENTIFIER)) == Ess_M2ePro_Helper_Data::CUSTOM_IDENTIFIER) {
