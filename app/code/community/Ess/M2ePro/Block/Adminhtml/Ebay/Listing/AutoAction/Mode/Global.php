...
class Ess_M2ePro_Block_Adminhtml_Ebay_Listing_AutoAction_Mode_Global extends Mage_Adminhtml_Block_Widget_Form
{
    // ####################################
    ...
    public function hasFormData()
    {
        ...
        return $listing->getData('auto_mode') == Ess_M2ePro_Model_Ebay_Listing::AUTO_MODE_GLOBAL;
    }
    ...
    public function getFormData()
    {
        ...
        return array(
            'auto_global_adding_mode' => $listing->getData('auto_global_adding_mode'),
            'auto_global_adding_template_category_id' => $listing->getData('auto_global_adding_template_category_id')
        );
    }
    ...
    public function getDefault()
    {
        return array(
            ...
            'auto_global_deleting_mode' => Ess_M2ePro_Model_Ebay_Listing::DELETING_MODE_STOP_REMOVE,
        );
    }
