...
class Ess_M2ePro_Block_Adminhtml_Common_Play_Account_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('general', array(
            ...
            'content' => $this->getLayout()->createBlock('M2ePro/adminhtml_common_play_account_edit_tabs_general')->toHtml(),
        ));
        ...
        $this->addTab('orders', array(
            ...
            'content' => $this->getLayout()->createBlock('M2ePro/adminhtml_common_play_account_edit_tabs_order')->toHtml(),
        ));
